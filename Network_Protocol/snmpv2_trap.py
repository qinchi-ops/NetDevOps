...
def analysis(info):
    ...
    # 1.3.6.1.2.1.1.3.0: {'application-wide': 'ApplicationSyntax','timeticks-value': '77997737','value': 'ObjectSyntax'}
    # 1.3.6.1.2.1.14.1.1: {'application-wide': 'ApplicationSyntax','ipAddress-value': '192.168.19.201','value': 'ObjectSyntax'}'value': 'ObjectSyntax'}
    # 1.3.6.1.2.1.14.7.1.12: {'integer-value': '6','simple': 'SimpleSyntax','value': 'ObjectSyntax'}
    # 1.3.6.1.2.1.14.7.1.2: {'integer-value': '0','simple': 'SimpleSyntax','value': 'ObjectSyntax'}
    # 1.3.6.1.6.3.1.1.4.1.0: {'objectID-value': '1.3.6.1.2.1.14.16.2.16','simple': 'SimpleSyntax','value': 'ObjectSyntax'}
    #1.3.6.1.2.1.14.10.1        ospfNbrEntry
    ...
    if '1.3.6.1.2.1.14.10.1.6' in info.keys():
        if info["1.3.6.1.2.1.14.10.1.6"]['integer-value'] == '8':
            print("OSPF neighbor",info["1.3.6.1.2.1.14.10.1.1"]['ipAddress-value'], "UP")
        elif info["1.3.6.1.2.1.14.10.1.6"]['integer-value'] == '1':
            print("OSPF neighbor",info["1.3.6.1.2.1.14.10.1.1"]['ipAddress-value'], "Down")
