...
def unpack_bootp_header(bin_data):
    ...
    bootp_sections_dict['CHADDR'] = '%s:%s:%s:%s:%s:%s' % (
    int_machex_str(sections[23]), int_machex_str(sections[24]), int_machex_str(sections[25]),
    int_machex_str(sections[26]), int_machex_str(sections[27]), int_machex_str(sections[28]))
