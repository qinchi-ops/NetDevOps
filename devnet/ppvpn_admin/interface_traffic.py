...
def get_data():
    ...
    try:
        ...
        link_speed = 0.0
    try:
        link_speed_recv = round((rx_bytes_2 - rx_bytes) / 1024 ** 2*8, 5)
    except ZeroDivisionError:
        link_speed_recv = 0.0
    try:
        link_speed_sent = round((tx_bytes_2 - tx_bytes) / 1024 ** 2*8, 5)
    except ZeroDivisionError:
        link_speed_sent = 0.0
    ...
    print("Currently recieving: " + str(link_speed_recv) + " MBb")
    print("Currently sending: " + str(link_speed_sent) + " Mb")
